...
- types are declared
- and symbol is &&
- for loops are done using counters
- loop bodies are put in curly brackets rather than tabs
- system.println vs print()
...
but your local copy doesn't know about the change yet. Here in another funny goofy ahahahah change.
